...
public class PurchaseTransactionsActivity extends AppCompatActivity implements TransactionAdapter.OnTransactionSelectedListener{
    private static final String TAG = "PurchaseTransaction";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PurchaseTransactionsActivity.this)
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PurchaseTransactionsActivity.this,RecordSaleActivity.class));
            }
        });
    }
        ...
        databaseRoot.child("transactions").child(user_id).child(trans_id).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(PurchaseTransactionsActivity.this,"Transaction deleted",Toast.LENGTH_SHORT).show();
                        loadTransactions();
                    }
                });
        ...
        databaseRoot.child("transactions").child(user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    ...
                    if(tx.getType() == AppConstants.PURCHASE){
                        purchaseTransactions.add(tx);
                    }
                }
                mProgressBar.setVisibility(View.GONE);
                mTransactionAdapter.setTransactionList(purchaseTransactions);
