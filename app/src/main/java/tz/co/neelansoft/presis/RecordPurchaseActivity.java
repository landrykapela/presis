...
public class RecordPurchaseActivity extends AppCompatActivity {
    private static final String TAG = "RecordPurchaseActivity";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mTextBeneficiary = findViewById(R.id.etBuyFrom);
    ...
    private void record_transaction(){
        ...
        Transaction transaction = new Transaction(dbRef.getKey(),mAmount,description,myDate,AppConstants.PURCHASE);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(RecordPurchaseActivity.this, "Successful", Toast.LENGTH_SHORT).show();
                        }
                        else{
    ...
    private void showDatePicker(DatePickerDialog.OnDateSetListener listener, Calendar cal){
        new DatePickerDialog(RecordPurchaseActivity.this,listener,
